This folder contains the data needed to reproduce the figures presented in the paper. Please note that Fig 1 does not contain any data, as it provides the framework for the sustainability analysis of ODT systems. Moreover, Fig 2 and Supplementary Fig 2 do not contain any data, as they are maps.
...
Fig4 Folder:
Contains the required data to generate the environmental footprint measures of transit systems.
